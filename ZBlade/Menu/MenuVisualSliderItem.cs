...
namespace ZBlade
{
	public class MenuVisualSliderItem : MenuSliderItem
	{
		...
		public override void Draw(SpriteBatch batch, Vector2 position, bool isSelected)
		{
            ...
            if (!isSelected)
                drawColor = new Color(drawColor.R, drawColor.G, drawColor.B, 127);
			...
			batch.Draw(
				...
				null,
				(IsEnabled) 
					? new Color(255, 255, 255, (byte)(barAppear.Position.X))
					: new Color(50, 50, 50, (byte)(barAppear.Position.X)),
				0f,
